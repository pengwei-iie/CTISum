...
def do_format_attack_to_lines(args):
    print(time.clock())
    data_builder.format_attack_to_lines(args)
    print(time.clock())

def do_format_general_to_lines(args):
    print(time.clock())
    data_builder.format_general_to_lines(args)
    print(time.clock())
...
def do_tokenize_attack(args):
    print(time.clock())
    data_builder.tokenize_attack(args)
    print(time.clock())
...
if __name__ == '__main__':
    ...
    parser.add_argument('-log_file', default='/Users/dingjunmei/code/PreSumm/logs/cnndm.log')
    #/Users/dingjunmei/code/PreSumm/logs
