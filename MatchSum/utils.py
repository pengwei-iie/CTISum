...
def get_data_path(mode, encoder):
    ...
    if mode == 'train':
        ...
        paths['train'] = 'data/CNNDM_sample/train_CNNDM_' + encoder + '.jsonl'
        paths['val']   = 'data/CNNDM_sample/val_CNNDM_' + encoder + '.jsonl'
    else:
        paths['test']  = 'data/CNNDM_sample/test_CNNDM_' + encoder + '.jsonl'
    return paths
